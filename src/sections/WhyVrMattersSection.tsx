  ...
  const content = [
    {
      ...
      content:
        "Create astonishingly real environments that engage the senses and blur the line between digital and physical worlds.",
    },
    {
      icon: "/assets/Applications.svg",
      heading: "Revolutionary Applications",
      content:
        "Revolutionise industries like training, education, healthcare, and entertainment by offering practical, interactive solutions.",
    },
    {
      icon: "/assets/Ship.svg",
      heading: "The Next Frontier",
      content:
        "Unlock new possibilities for storytelling, fostering collaboration, and connecting people across the globe in profound, shared experiences.",
    },
  ];
        ...
        {content.map((item, index) => (
          <Grid key={index} size={{ xs: 12, md: 4 }}>
            ...
            >
              ...
              <h3 className="text-lg font-bold text-white mb-4 text-gradient card-heading">
                {item.heading}
              </h3>
